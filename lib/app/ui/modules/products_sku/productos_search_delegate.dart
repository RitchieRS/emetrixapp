...
class ProductosSearchDelegate extends SearchDelegate<ProductosIsar> {
  ProductosSearchDelegate(this.productosList, this.index, this.stepsLenght,
      this.store, this.storeUuid, this.stepUuid, this.sondeoItem);
        ...
        if (snapshot.data != null) {
          ...
          productList = productList
              .where((p) =>
                  ...
                  p.productos?.sku!.contains(query.trim().toLowerCase()) ??
                  false)
              .toList();
